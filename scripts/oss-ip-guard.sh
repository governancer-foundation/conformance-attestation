...
WHITELIST='@governancer-foundation/conformance-attestation|\.env\.example|oss-ip-guard|negative-list|BLOCK_CORPUS|BLOCK_INTERNAL|BLOCK_SECRET|BLOCK_TRAILER|WHITELIST'
